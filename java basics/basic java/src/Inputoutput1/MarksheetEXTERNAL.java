...
public class MarksheetEXTERNAL implements Externalizable {
	   ...
	   private int chemistry = 0;
	    ...
	    public MarksheetEXTERNAL() {
	  
	    }
	    public MarksheetEXTERNAL(String na,int m,int p,int c) {
	    	name = na;
	    	maths = m;
	    	physics = p;
	    	chemistry = c;
